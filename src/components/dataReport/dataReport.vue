<template>
    <div>
        <div class="header">
            <span class="logo">
                <img src="../../common/images/logo_white_bg.png">
            </span>
            <img src="../../common/images/Artwork@2x.png" width="100%">
            <div class="context">
            ...
            <div class="section-bd">
                ...
                <div class="cooperatives">
                    ...
                    <div class="company-brand">
                        <span><img src="../../common/images/Group5@2x.png"></span>
                        <span><img src="../../common/images/Group6@2x.png"></span>
                        <span><img src="../../common/images/Group7@2x.png"></span>
                    </div>
...
<script>
    ...
    import { scrollTop } from '@/common/js/util'
    ...
    export default {
        ...
        methods: {
            ...
            getAgentDistricts() {
                console.log('getAgentDistricts')
                this.$axios.get('/agent/districts').then((res) => {
                    if (res.status == 1) {
            ...
            getUsersStatistics() {
                this.$axios.get('/users/statistics').then((res) => {
                    if (res.status == 1) {
            ...
            getAgentStatistics() {
                this.$axios.get('/agent/statistics').then((res) => {
                    if (res.status == 1) {
